    ...
    return (
        <div className="App">
            ...
            <div className="row">
                <div className="col-2"></div>
                <div className="col-8">
                    <SearchBar addMods={addMods} placeholder="Enter a Subject Name..." data={data}/></div>
                <div className="col-2"></div>
            </div>
